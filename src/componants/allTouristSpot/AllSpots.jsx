            ...
            <div className="card glass">
                ...
                <div className="card-body">
                    ...
                    <div className="flex justify-between mt-5">
                        <Link to={`/spot/${_id}`}>  <button className="btn-outline bg-[#33b249] w-full hover:bg-[#5adbb5] hover:text-black duration-500 p-3 rounded text-white">View Details</button></Link>
                    </div>
                </div>
            </div>
        </div>
